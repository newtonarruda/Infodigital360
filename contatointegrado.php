	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="images/banner01_normal.jpg" alt="Sua empresa em 360° no Google Maps!">
			</div>

			<div class="item">
				<img src="images/banner02_normal.jpg" alt="Todas as informações de seu empreendimento para acesso rápido">
			</div>

			<div class="item">
				<img src="images/banner03_normal.jpg" alt="24 Horas por dia, no Google, acesso rápido em todos os dispositivos!!">
			</div>
		</div>
